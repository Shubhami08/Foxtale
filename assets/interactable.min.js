!(function (t, e) {
    ...
    let r = n(t),
      ...
      c =
        "x" === s
          ...
          : "top";
    return (
      e.reference[l] > e.floating[l] && (c = f(c)), { main: c, cross: f(c) }
    );
  }
        ...
        void 0 === t && (t = {}),
        {
          ...
          async fn(i) {
            ...
            let {
              ...
              I =
                ...
                (d
                  ...
                  : u.filter((t) => e(t) === t)
                ).filter((t) => !d || n(t) === d || (!!p && g(t) !== t))),
              D = await l(i, k),
              P =
                null != (a = null == (o = y.autoPlacement) ? void 0 : o.index)
                  ? a
                  : 0,
              S = I[P],
              { main: E, cross: A } = m(
                S,
                v,
                await (null == w.isRTL ? void 0 : w.isRTL(x.floating))
              );
            if (b !== S)
            ...
            let R = [D[e(S)], D[E], D[A]],
              L = [
                ...(null !=
                (r = null == (s = y.autoPlacement) ? void 0 : s.overflows)
                  ? r
                  : []),
        ...
        async fn(t) {
          ...
          switch (e) {
            case "referenceHidden": {
              ...
              return {
                data: { referenceHiddenOffsets: a, referenceHidden: b(a) },
              };
            }
            case "escaped": {
            ...
            if (p) {
              ...
              let I = "y" === f ? "width" : "height",
                ...
                S =
                  ...
                  (D
                    ? 0
                    : null != (T = null == (k = l.offset) ? void 0 : k[m])
                    ? T
                    : 0) -
                  (D ? $.crossAxis : 0);
              g < P ? (g = P) : g > S && (g = S);
              ...
              w = {
                height:
                  ...
                  (["left", "right"].includes(a)
                    ? 2 * (0 !== y || 0 !== b ? y + b : d(u.top, u.bottom))
                    : u[h]),
                width:
                  o.floating.width -
                  (["top", "bottom"].includes(a)
                    ? 2 * (0 !== v || 0 !== $ ? v + $ : d(u.left, u.right))
                    : u[g]),
              };
  ...
  (function (t, e) {
    ...
    function h(t, e) {
      ...
      return (
        e &&
          ...
          (a = (t.offsetHeight > 0 && m(n.height) / t.offsetHeight) || 1)),
        {
          width: n.width / i,
          height: n.height / a,
          top: n.top / a,
    ...
    function y(t) {
      return "html" === o(t)
        ? t
        : t.assignedSlot || t.parentNode || (l(t) ? t.host : null) || g(t);
    }
    function b(t) {
      ...
      return "viewport" === n
        ...
        : e.rectToClientRect(
            (function (t) {
              ...
              return (
                "rtl" === a(o || n).direction &&
                  (l += f(n.clientWidth, o ? o.clientWidth : 0) - r),
    ...
    Object.defineProperty(t, "arrow", {
      ...
      (t.autoUpdate = function (t, e, n, i) {
        ...
        r &&
          !l &&
          ((m = new ResizeObserver(n)), s(t) && m.observe(t), m.observe(e));
        let g = l ? h(t) : null;
        return (
          l &&
            (function e() {
      ...
      (t.computePosition = (t, n, i) =>
        e.computePosition(t, n, { platform: T, ...i })),
  ...
  (function (t) {
    ...
    t.fn.hoverIntent = function (i, a, l) {
      ...
      return (
        t.isPlainObject(i)
          ? n((d = t.extend(d, i)).out) || (d.out = d.over)
          : (d = n(a)
              ? t.extend(d, { over: i, out: a, selector: l })
              : t.extend(d, { over: i, out: i, selector: a })),
        this.on(
  ...
  (function (t, e) {
    ...
    return function (t, e, n, i) {
      ...
      var s,
          ...
          te &&
            (t &&
              (g > o.currItem.fitRatio
                ? tb || (eN(o.currItem, !1, !0), (tb = !0))
                : tb && (eN(o.currItem), (tb = !1))),
            tk(te, tp.x, tp.y, g));
        },
        tD = function (t) {
          t.container &&
        ...
        tS = function (t, e) {
          if (!r.loop && e) {
            var n = d + (th.x * tf - t) / th.x,
              i = Math.round(t - tJ.x);
            ((n < 0 && i > 0) || (n >= eD() - 1 && i < 0)) &&
              (t = tJ.x + i * r.mainScrollEndFriction);
          }
          (tJ.x = t), tP(t, p);
        },
        tE = function (t, e) {
        ...
        en = function (t, e) {
          return (
            (t4.x = Math.abs(t.x - e.x)),
            (t4.y = Math.abs(t.y - e.y)),
            Math.sqrt(t4.x * t4.x + t4.y * t4.y)
          );
        },
        ei = function () {
          V && (A(V), (V = null));
        ...
        eo = function (t, e) {
          return (
            ...
            (e(t) ? t : eo(t.parentNode, e))
          );
        },
        er = {},
        es = function (t, e) {
          return (
            (er.prevent = !eo(t.target, r.isClickableElement)),
            t2("preventDragEvent", t, e, er),
            er.prevent
          );
        },
        el = function (t, e) {
        ...
        ed = function () {
          return (
            1 - Math.abs((tp.y - o.currItem.initialPosition.y) / (tu.y / 2))
          );
        },
        ep = {},
        eu = {},
        ...
        em = function (t) {
          ...
          return (
            P
              ...
              ? t.touches &&
                t.touches.length > 0 &&
                ((ef[0] = el(t.touches[0], ep)),
                t.touches.length > 1 && (ef[1] = el(t.touches[1], eu)))
              : ((ep.x = t.pageX),
                (ep.y = t.pageY),
                (ep.id = ""),
                (ef[0] = ep)),
        ...
        eh = function (t, e) {
          ...
          return (
            ...
            (te
              ? "h" !== ti ||
                ...
                (c
                  ? (l > tt.min[t] &&
                      ...
                      (i = tt.min[t] - td[t])),
                    (i <= 0 || p < 0) && eD() > 1
                      ? ((s = d), p < 0 && d > tX.x && (s = tX.x))
                      : tt.min.x !== tt.max.x && (a = l))
                  : (l < tt.max[t] &&
                      ((n = r.panEndFriction),
                      tt.max[t],
                      (i = td[t] - tt.max[t])),
              ...
              : (s = d),
            "x" === t)
              ? (void 0 !== s && (tS(s, !0), (X = s !== tX.x)),
                tt.min.x !== tt.max.x &&
                  (void 0 !== a ? (tp.x = a) : X || (tp.x += e.x * n)),
                void 0 !== s)
              : void (
                  tn ||
                  X ||
                  (g > o.currItem.fitRatio && (tp[t] += e[t] * n))
                )
          );
        },
        eg = function (t) {
          if (!("mousedown" === t.type && t.button > 0)) {
            ...
            if (!G || "mousedown" !== t.type) {
              if ((es(t, !0) && t.preventDefault(), t2("pointerDown"), P)) {
                ...
                e < 0 && (e = t3.length),
                  (t3[e] = { x: t.pageX, y: t.pageY, id: t.pointerId });
              }
              var n = em(t),
                i = n.length;
              (Y = null),
              ...
              if (
                ...
                a >
                  o.currItem.initialZoomLevel +
                    o.currItem.initialZoomLevel / 15 && (ts = !0);
                var s = 1,
                  l = tN(),
                  c = tF();
                if (a < l) {
                ...
                if (
                  ...
                  (ta &&
                    ((ta = !1),
                    Math.abs(tj.x) >= 10 && (tj.x -= Y[0].x - t7.x),
                    Math.abs(tj.y) >= 10 && (tj.y -= Y[0].y - t7.y)),
                  (tV.x = tq.x),
                  (tV.y = tq.y),
                  0 === tj.x && 0 === tj.y)
                )
            ...
            if ((tZ(), H || (H = eb()), H.calculateSwipeSpeed("x"), z)) {
              if (ed() < r.verticalDragRange) o.close();
                ...
                t1("verticalDrag", 0, 1, 300, a.easing.cubic.out, function (t) {
                  (tp.y = (o.currItem.initialPosition.y - d) * t + d),
                    tT((1 - p) * t + p),
                    tI();
                }),
                  t2("onVerticalDrag", 1);
              ...
              if (!tn)
                return "swipe" !== i
                  ? void e8()
                  : void (!X && g > o.currItem.fitRatio && ew(H));
            }
          }
        },
        eb = function () {
            ...
            n = {
              ...
              panAnimLoop: function () {
                if (
                  ...
                  return (
                    (tp.x = Math.round(tp.x)),
                    (tp.y = Math.round(tp.y)),
                    tI(),
                    void tz("zoomPan")
                  );
              },
        ...
        ex = function (t, e) {
          ...
          l &&
            ((d += l) < 0
              ? ((d = r.loop ? eD() - 1 : 0), (c = !0))
              : d >= eD() && ((d = r.loop ? 0 : eD() - 1), (c = !0)),
            (c && !r.loop) || ((tg += l), (tf -= l), (s = !0)));
          var s,
            l,
            c,
            p,
          ...
          return (
            ...
            t1("mainScroll", tJ.x, u, p, a.easing.cubic.out, tS, function () {
              tZ(),
                (tn = !1),
                (tQ = -1),
                (s || tQ !== d) && o.updateCurrItem(),
                t2("mainScrollAnimComplete");
            }),
                  ...
                  var n = u.w / e.w,
                    ...
                    c = function (e) {
                      1 === e
                        ...
                        : ((g = (n - r) * e + r),
                          (tp.x = (u.x - o.x) * e + o.x),
                          (tp.y = (u.y - N - o.y) * e + o.y)),
                        tI(),
                        p ? (t.style.opacity = 1 - e) : tT(s - e * s);
                    };
                  l
                    ? t1("initialZoom", 0, 1, f, a.easing.cubic.out, c, m)
                    : (c(1), (e2 = setTimeout(m, f + 20)));
                } else
                  (g = e.initialZoomLevel),
                    tA(tp, e.initialPosition),
                    tI(),
          ...
          if (t.src && !t.loadError) {
            ...
            if (
              (l &&
                ...
                t2("parseVerticalMargin", t)),
              (eS.x = e.x),
              (eS.y = e.y - t.vGap.top - t.vGap.bottom),
              l)
            ) {
              var c = eS.x / t.w,
                d = eS.y / t.h;
            ...
            return (
              ...
              (s.max.y =
                o > eS.y ? Math.round(eS.y - o) + i.vGap.top : s.center.y),
        ...
        eF = function () {
          if (eE.length) {
            for (var t, e = 0; e < eE.length; e++)
              (t = eE[e]).holder.index === t.index &&
                e9(t.index, t.item, t.baseDiv, t.img, 0, t.clearPlaceholder);
            eE = [];
          }
        };
      tw("Controller", {
        publicMethods: {
          ...
          setContent: function (t, e) {
            ...
            if (l) {
              ...
              eT || e !== d ? tD(l) : ((te = c.style), eP(l, i || l.img)),
                (t.el.innerHTML = ""),
                t.el.appendChild(c);
            } else t.el.innerHTML = "";
          },
          ...
          publicMethods: {
            ...
            handleMouseWheel: function (t) {
              if (g <= o.currItem.fitRatio)
                return (
                  r.modal &&
                    (!r.closeOnScroll || tW || Z
                      ? t.preventDefault()
                      : D && Math.abs(t.deltaY) > 2 && ((c = !0), o.close())),
                  !0
                );
              if ((t.stopPropagation(), (eU.x = 0), "deltaX" in t))
                1 === t.deltaMode
                  ? ((eU.x = 18 * t.deltaX), (eU.y = 18 * t.deltaY))
                  : ((eU.x = t.deltaX), (eU.y = t.deltaY));
              else if ("wheelDelta" in t)
                t.wheelDeltaX && (eU.x = -0.16 * t.wheelDeltaX),
                  t.wheelDeltaY
                    ? (eU.y = -0.16 * t.wheelDeltaY)
                    : (eU.y = -0.16 * t.wheelDelta);
              else {
          ...
          if ((ez && clearTimeout(ez), tW || Z)) ez = setTimeout(e5, 500);
            ...
            e3
              ? "#" + n !== window.location.hash &&
                history[eK ? "replaceState" : "pushState"](
                  "",
                  document.title,
                  i
                )
      ...
      tw("History", {
        publicMethods: {
          initHistory: function () {
            if ((a.extend(r, eX, !0), r.history)) {
              (e7 = window.location),
                ...
                eq.indexOf("gid=") > -1 &&
                  (eq = (eq = eq.split("&gid=")[0]).split("?gid=")[0]),
          ...
          onHashChange: function () {
            return eY() === eq
              ? ((ej = !0), void o.close())
              : void (eG || ((eZ = !0), o.goTo(eQ().pid), (eZ = !1)));
          },
          updateURL: function () {
            ...
            if (0 !== tg) {
              ...
              if (!(t && n < 2)) {
                (o.currItem = eI(d)),
                  (tb = !1),
                  t2("beforeChange", tg),
                  n >= 3 && ((u += tg + (tg > 0 ? -3 : 3)), (n = 3));
                for (var i = 0; i < n; i++)
                  tg > 0
                    ? ((e = x.shift()),
                      (x[2] = e),
                      tP((++u + 2) * th.x, e.el.style),
                      o.setContent(e, d - n + i + 1 + 1))
                    : ((e = x.pop()),
                      x.unshift(e),
                      tP(--u * th.x, e.el.style),
                      o.setContent(e, d + n - i - 1 - 1));
                if (te && 1 === Math.abs(tg)) {
                  var a = eI(C);
          ...
          updateSize: function (e) {
            if (!tv && r.modal) {
              ...
              if (
                ...
                !e && ty.x === window.innerWidth && ty.y === window.innerHeight)
              )
                return;
              (ty.x = window.innerWidth),
                (ty.y = window.innerHeight),
                (t.style.height = ty.y + "px");
            }
            if (
            ...
            (v = g = o.currItem.initialZoomLevel),
              (tt = o.currItem.bounds) &&
                ((tp.x = tt.center.x), (tp.y = tt.center.y), tI(!0)),
              t2("resize");
          },
          zoomTo: function (t, e, n, i, o) {
            e &&
              ((v = g),
              (et.x = Math.abs(e.x) - tp.x),
              (et.y = Math.abs(e.y) - tp.y),
              tA(td, tp));
            var r = tO(t, !1),
              s = {};
      ...
      (b.init = function () {
        ...
        e.extend(t.options, _, !0),
          ...
          p("unbindEvents", function () {
            C || P(),
              ...
              n &&
                (e.unbind(document, n.eventK, b.updateFullscreen),
          ...
          g.fullscreenEl &&
            ...
            n
              ? (e.bind(document, n.eventK, b.updateFullscreen),
                b.updateFullscreen(),
        ...
        (b.onGlobalTap = function (n) {
          ...
          if (!v) {
            if (n.detail && "mouse" === n.detail.pointerType) {
              ...
              g.tapToClose && (e.hasClass(i, "pswp__img") || A(i)))
            )
              return void t.close();
          }
        }),
        (b.onMouseOver = function (t) {
          k(
            i,
            "ui--over-close",
            A((t = t || window.event).target || t.srcElement)
          );
        }),
  ...
  (function (t) {
    ...
    (T4SThemeSP.Tooltip = (function () {
      ...
      (T4SThemeSP.LookBook = (function () {
        ...
        function p() {
          r && (a.removeClass(c), T4SThemeSP.Helpers.disableBodyScroll(!1, d)),
            t("[data-pin-close],[data-pin-popup]." + i.clicked).off(
              "click.closelb"
            ),
        ...
        function u(o, s, u = "lb") {
          let m;
          (h = s),
            r && (a.addClass(c), T4SThemeSP.Helpers.disableBodyScroll(!0, d)),
            (m = t("#" + h)).addClass(i.opened),
            m.hasClass("is-style-mb--false") || l.addClass(i.visible);
          var h,
            g,
            v,
            $,
          ...
          (e.width() > 767 || w.hasClass("is-style-mb--false")) &&
            ...
            "lb" == u
              ? (n.on("click.closelb", function (e) {
                ...
                t(`#${s} [data-pin-close], [data-pin-popup].${i.clicked}`).on(
                  "click.closelb",
                  function (t) {
        ...
        function f() {
          a.removeClass(c),
            ...
            t("[data-dropdown-close],[data-dropdown-open]." + i.clicked).off(
              "click.closeDrop"
            ),
                    ...
                    t("#" + e).on(
                      ...
                      function (n) {
                        ...
                        a
                          ...
                          t(
                            '[data-dropdown-open][data-id="' + e + '"]>span'
                          ).text(a.text()),
          ...
          t
            ...
            "1" != z &&
              ...
              s.attr(
                ...
                ((n = a),
                /variant=/.test((e = l))
                  ? e.replace(/(variant=)[^&]+/, "$1" + n)
                  : /\?/.test(e)
                  ? e.concat("&variant=").concat(n)
                  : e.concat("?variant=").concat(n))
              );
        }
            ...
            J(),
              t("[data-product-options]:not(.is-t4s-pr-created)").each(
                function () {
                  ...
                  "boolean" != typeof _.unQuickShopInline &&
                    (_.unQuickShopInline = !0),
                    (n = d),
                    (a = _.image2),
                    (o = _.alt),
                    (c = ""),
                    "2" == m &&
                      a &&
                      ((c = p.replace("image_src", a).replace("image_alt", o)),
                      n.find(".t4s-product-img").addClass("is-show-img2")),
                    ...
                    (function (t, n, a) {
                      ...
                      var b = (g = t.find("[data-atc-selector]")).find(
                          ".t4s-text-pr"
                        ),
                      ...
                      if (n.isExternal)
                        g
                          ...
                          .attr("target", "_blank"),
                          b.text(n.external_title),
                          w.attr("xlink:href", "#t4s-icon-external");
                      else if (n.available) {
                        if (n.isGrouped) b.text(E);
                        else if (n.isDefault) {
                          if (
                            (n.isPreoder && b.text(I),
                            g.attr({
                              "data-action-atc": "",
                          ...
                          h && n.unQuickShopInline
                            ? (g.attr("data-action-quickshop", ""), b.text(S))
                            : b.text(P);
                ...
                function (a) {
                  ...
                  if (!r.hasClass(R)) {
                    ...
                    if (
                      ...
                      (T4SThemeSP.iDVariantEdit = p),
                      (T4SThemeSP.keyVariantEdit = r.data("key")),
                      u)
                    )
                      T4SThemeSP.NTpopupInline(u, c, l ? e : i, d),
            ...
            C &&
              ...
              o.on(
                ...
                function (e) {
                  ...
                  n.hasClass(L)
                    ? (n.removeClass(L), t(this).siblings().text(U))
                    : (n.addClass(L), t(this).siblings().text(B));
                }
              );
          },
          ...
          reloadReview: function () {
            if ("1" == G)
              ...
              "8" == G
                ...
                : "6" == G && o.trigger("reloadReview.t4s");
          },
      ...
      (T4SThemeSP.ProductAjax = (function () {
        ...
        function y(t, e, i) {
          var flag = true;
          console.log(new Date(), "000000000000000")
          ...
          o.addClass("is--contentUpdate"),
            ...
            n.on("cart:updated", function (t) {
              console.log(new Date(), "111111111111")
              if (flag) {
                cartGiftUpdate();
                flag = false;
              }
          ...
          (c.headers["X-Requested-With"] = "XMLHttpRequest"),
            (c.body = JSON.stringify({ id: `${e}`, quantity: i })),
            fetch(`${d}`, c)
              .then((t) => t.json())
              .then((t) => {
                if (t.status)
                  return $(t.description), void n.trigger("cart:updated");
                b(t.sections);
              })
              .catch((t) => {
              ...
              if (
                ...
                return (
                  ...
                  (r = setTimeout(function () {
                    a.find(".is--animated.t4s-ani-shake").removeClass(
                  ...
                  r.append("sections", f),
                    ...
                    fetch(`${c}`, a)
                      ...
                      .then((t) => {
                        if (t.status)
                          return (
                            $(t.description), void n.trigger("cart:updated")
                          );
                        if (
...
Product added to cart!  <a onclick="viewCart()" href="javascript.void(0)"  data-drawer-options='{ "id":"#t4s-mini_cart" }'>View Cart</a>`),
                    ...
                    var var_o = document.getElementById("t4s-mini_cart"),
                      ...
                      var_l_new = document.getElementById(
                        "t4s_cart_spinner_new"
                      );
        ...
        function () {
          o.on("change", "[data-quantity-value]", function (e) {
            ...
            if (
              ...
              parseInt(i) > parseInt(a))
            ) {
              if (
                (n.val(a), n.attr(C, a), s != a && n.attr(C, a).trigger(g), x)
              )
                return;
              return T4SThemeSP.Notices(w.replace("[max]", a)), !1;
            }
            if (parseInt(i) < parseInt(r))
              return n.val(r), s != r && n.attr(C, r).trigger(g), !1;
        ...
        function () {
          _ ||
            ...
            o.on("click", T, function (e) {
              t(this).closest("form"),
                t(this).is(":checked") && o.trigger("hide.t4s.notices");
            }));
        })),
                ...
                if (a.is("[data-pswp-btn-triger]")) {
                  ...
                  (c =
                    ...
                    f.hasClass("flickityt4s-enabled")
                      ? f.find(m + ".is-selected").index()
                      : t(d.currentTarget).is(l)
                      ? 0
                      : t(d.currentTarget).index())),
                    ...
                    N =
                      ...
                      x.each(function () {
                        (C = t(this)),
                          _.push({
                            src:
                              C.attr("data-pswp-src") || C.attr("data-master"),
                  ...
                  (I = (k = (T = {
                    ...
                    (S = {
                      ...
                      getThumbBoundsFn: function (t) {
                        ...
                        T.global &&
                          (e = P.find("a[data-index=" + t + "]").parents(
                            T.parents
                          ));
                        var n =
                            window.pageYOffset ||
          ...
          initPoster: function () {
            t("[data-video-poster-btn]").on("click", function (i) {
              ...
              n(),
                (function (e, n) {
                  if (!e.is("[loaded]")) {
                    var i = e.find("[data-video-insert]").length
              ...
              t("[data-video-poster-close]").on("click", function (i) {
                i.preventDefault(), n();
                var a = t(this).closest("[data-video-poster]");
                a.removeAttr("loaded").removeClass(e),
          ...
          (i.prototype = Object.assign({}, i.prototype, {
            setupEventListeners: function () {
              ...
              i.$container.on("click.ntlm", "[data-load-more]", function (a) {
                ...
                let o = t(this);
                o.addClass(n),
                  (e = `${o.attr("data-href") || o.attr("href")}&section_id=${
                    i.main
                  }`),
    ...
    (T4SThemeSP.initLoadMore = function () {
        ...
        function c(e, n, i, a, c, d, p) {
          ...
          t.each(n, function (t, e) {
            ...
            isStorageSpSessionAll &&
              i &&
              (sessionStorage.setItem("nt_ins" + a + d, u),
              ...
              !(function (t) {
                ...
                if ("spnt_t4" != m) {
                  if (
                    ...
                    if (
                      (t.html(d).parent().addClass(l.loaded),
      ...
      (T4SThemeSP.sideBarInit = function () {
        ...
        if (0 != i.length) {
          var l,
            c = `${window.location.pathname}?section_id=${i.attr(
              "data-sidebar-id"
      ...
      (T4SThemeSP.Drawer = (function () {
        ...
        function f(n, o, r = !1) {
          if (!i) {
            ...
            var p = b(o.attr(s)),
              f = r ? o : t(p.id);
            f.trigger("opendDrawer"),
              f.attr("aria-hidden", "false"),
              l.addClass(e.overlayVisible),
              (i = !0),
              a.addClass(c + u),
          ...
          e.find(L)
            ...
            .on("click", function (e) {
              ...
              n.hasClass("t4s--menu-toggle") && (n = n.closest("a")),
                n.hasClass(S)
                  ? n.removeClass(S).siblings("ul").slideUp(200)
                  : n.addClass(S).siblings("ul").slideDown(200);
            });
        }
        function W(e) {
          e && (x = e),
        ...
        function q(e, n = !1) {
          ...
          if (
            ...
            ("bottom" != r ||
              ...
              (FloatingUIT4sDOM.computePosition(a, o, {
                placement: r,
                middleware: [
                  FloatingUIT4sDOM.flip({}),
                  FloatingUIT4sDOM.shift({ padding: 5 }),
          ...
          stickyInit: function () {
            !v ||
              ...
              e.on("resize", function () {
                a.css({
                  "--topbar-height": t("#t4s-top-bar-main").height() + "px",
                  "--header-height": t(".t4s-section-header").height() + "px",
                });
              });
          },
          init: function (n) {
            (function () {
              ...
              if (!(0 == e.length || i < 1024)) {
                if (!IsDesignMode && l > 0 && l >= Date.now())
                  ...
                  function f(t) {
                    T4SThemeSP.getToFetchSection("?sections=" + p, "json").then(
                      (t) => {
              ...
              (function () {
                if (0 != D.find("[data-wrapper-categories]").length) {
                  if (IsDesignMode || 0 != P.length)
                    IsDesignMode && ((D = t(k)), K((P = t(I)).html()));
                  else {
                    var e = h + "timeCatT4s",
                      n = h + "dataCatT4s",
                      i =
                        (isStorageSpSession && sessionStorage.getItem(e)) || 0;
                    (i = parseInt(i)) > 0 && i >= Date.now()
                      ? K(sessionStorage.getItem(n))
                      : T4SThemeSP.getToFetchSection(
                          null,
                          "text",
                          u + "/?section_id=header-categories"
                        ).then((t) => {
                          if ("NVT_94" != t) {
                            var a = new DOMParser()
      ...
      (T4SThemeSP.MobileNav = (function () {
        ...
        function b(t) {
          t.hasClass(o.opend)
            ? t.removeClass(o.opend).children("ul").slideUp(200)
            : t.addClass(o.opend).children("ul").slideDown(200);
        }
        function w(t = 4) {
          IsDesignMode ||
            u ||
            ...
            setTimeout(function () {
              if (l > 0) {
                ...
                T4SThemeSP.getToFetchSection("?section_id=" + n, "text").then(
                  (n) => {
                    "NVT_94" != n &&
                      (y.$mobileNav.find("#shopify-mb_nav").html(n),
                      e ? x("indexPage") : (t = !0));
                  }
                ),
                  T4SThemeSP.getToFetchSection("?section_id=" + a, "text").then(
                    (n) => {
                      "NVT_94" != n &&
                        (y.$mobileNav.find("#shopify-mb_cat").html(n),
                        t ? x("indexPage") : (e = !0));
                    }
                  );
              } else
            ...
            y.$mobileNav.on(
              ...
              function () {
                ...
                e.hasClass(o.tabNavActive) ||
                  ...
                  t("[data-tab-mb-content]." + o.tabNavActive).removeClass(
                    o.tabNavActive
                  ),
      ...
      (T4SThemeSP.productRecommendations = (function () {
        ...
        function n(n) {
          n[0]
            ...
            ? (e.$recommendationsWrap.find(".t4s-loading--bg").hide(),
              e.$recommendationsWrap.find("[data-emty-product]").show())
            : ((T4SThemeSP.isRelatedEmty = !0),
              T4SThemeSP.isRencentEmty
                ? t(".t4s-tp-rencent-related").hide()
                : e.$recommendationsWrap.hide());
        }
        return function (i) {
          var a, o, r, s, l, c;
          (e = {
              ...
              T4SThemeSP.getToFetchSection(null, "text", c).then((e) => {
                if ("NVT_94" != e) {
                  ...
                  if ("" !== i.trim()) {
                    if (
                      (a.html(i),
                      a.find(".t4s-product").length > 0 &&
                        T4SThemeSP.reinitProductGridItem(),
                      a.find(".flickityt4s").length > 0)
                    ) {
      ...
      (T4SThemeSP.recentlyViewed = (function () {
        ...
        function n(n, i = !0) {
          n[0]
            ...
            ? (e.$recentlyWrap.find(".t4s-loading--bg").hide(),
              e.$recentlyWrap.find("[data-emty-product]").show())
      ...
      (T4SThemeSP.Cart = (function () {
                      ...
                      a.addClass("is--opend"),
                        ...
                        t("[data-cart-tool_close]").on("click", function (n) {
                          n.preventDefault(),
                            ...
                            t("[data-cart-tool_close]").off("click");
                        }),
                        o
                          .off("keyup.drawer")
                          .on("keyup.toolCart", function (n) {
                            27 === n.keyCode &&
                              (t(
                                ".t4s-mini_cart-tool__content.is--" +
                                  i.data("id")
        ...
        function P(d, u = !0) {
          ...
          g.html(h.find(e).html()),
            ...
            0 == m[0]
              ...
              : (a.removeClass("t4s-cart-count-0"), _ && (O(), (_ = !1))),
              ...
              "1" == $ ||
                ...
                ("3" == $
                  ...
                  : (document.location.href =
                      "5" == $ ? T4SThemeSP.root_url + "checkout" : k))),
            n.trigger("cart:updated"),
            L();
        }
        function S() {
          ...
          if (isStorageSpdLocal) {
            ...
            n.val(i).trigger("keyup"),
              t('[data-action="save-discountcode"]').click(function (t) {
                localStorage.setItem("CartDiscountcode", e.val()),
                  n.val(e.val()).trigger("keyup");
              });
          }
        }
        function A() {
        ...
        function O() {
          ...
          T4SThemeSP.getToFetchSection(null, "text", i).then((n) => {
            ...
            T.flickityt4s && T.flickityt4s.destroy(),
              e.html(t(n).html()),
              o.trigger("currency:update"),
              T4SThemeSP.Tooltip();
        ...
        return {
          ...
          init: function () {
            (function () {
              if ("cart" == p)
                return (
                  S(), A(), E(), R(), T4SThemeSP.agreeForm(), L(), void O()
                );
              IsDesignMode
                ? I()
                : v ||
                  T4SThemeSP.getToFetchSection("?section_id=mini_cart").then(
                    (e) => {
                      "NVT_94" != e &&
                        (t("#t4s-mini_cart").parent().remove(),
                        T4SThemeSP.$appendComponent.after(t(e).html()),
                        I());
                    }
                  );
            })(),
        ...
        return function () {
          ...
          IsDesignMode
            ...
            : ((t = h + "timeLoginT4s"),
              ...
              (i = parseInt(i)) > 0 && i >= Date.now()
                ? (T4SThemeSP.$appendComponent.after(sessionStorage.getItem(e)),
                  T4SThemeSP.Drawer.remove("t4s-login-sidebar"),
                  n())
                : T4SThemeSP.getToFetchSection(
                    ...
                    "NVT_94" != a &&
                      (T4SThemeSP.$appendComponent.after(a),
                      T4SThemeSP.Drawer.remove("t4s-login-sidebar"),
                      n(),
                      isStorageSpSession &&
                        ((i = Date.now() + 24e6),
      ...
      (T4SThemeSP.Compare = (function () {
        ...
        function x() {
          ...
          null != t &&
            ((e = t.split(",")), (g = h + encodeURI(t.replace(/,/g, " OR "))));
        }
        function C() {
        ...
        function _(e, n) {
          ...
          i.addClass(c).removeClass(l).find(".t4s-text-pr").text(p),
            i.find(".t4s-svg-pr-icon").html($),
          ...
          init: function () {
            isStorageSpdLocalAll &&
              ...
              o.on("click", a + "." + c, function (t) {
                t.preventDefault(),
                  t.stopPropagation(),
                  y ? n.addClass(d) : (window.location.href = g);
              }),
              ...
              o.on("click", a + ":not(." + c + ")", function (e) {
                ...
                var n = t(this),
                  ...
                  p = !1;
                if ("" != i) {
                  if ((n.addClass(l), null != d && d.length > 0))
                    (u = d.split(",")).unshift(o);
                  else {
                    var u = [];
                    u.unshift(o);
                  ...
                  if (
                    ((u = u.filter(w)).length > 6 &&
                      ((u = u.splice(0, 6)), (p = !0)),
                    localStorage.setItem(s, u.toString()),
                    (m = u.length),
                    p)
                  ) {
                    var h = t(a + c);
                    h.removeClass(c).find(".t4s-text-pr").text(f),
                      h.find(".t4s-svg-pr-icon").html(v),
                      C();
                  } else _(i, n);
      ...
      (T4SThemeSP.Wishlist = (function () {
        ...
        function L(e) {
          ...
          o > -1 ? (_ = _.splice(0, 51)).splice(o, 1) : (_ = _.splice(0, 50)),
            localStorage.setItem(m, _.toString()),
            e.removeClass(h),
          ...
          e.addClass(D + " " + h),
            fetch(P, {
              ...
              .then(function (i) {
                if ("success" == i.status) {
                  Array.isArray(
                    (S = _ = JSON.parse(i.response.metafield.value).the4_ids)
                  ) || (S = S.split(",")),
                    e.trigger("destroyTooltip");
                  ...
                  if (a.length > 0) {
                    ...
                    (o = o[0]
                      ...
                      a.hasClass("isotopet4s-enabled")
                        ? a.isotopet4s("remove", o[0]).isotopet4s("layout")
                        : o.remove();
                  }
                  t(c + '[data-id="' + n + '"]')
                    .removeClass(g)
        ...
        function N() {
          ...
          null != t &&
            ((_ = t.split(",")),
            (C = x + encodeURI(t.replace(/,/g, " OR "))),
            (T4SThemeSP.linkWishlist = C),
            n.trigger("update:mini_cart:wishlist"));
        }
        function F() {
          0 != (_ = S).length &&
            ((C = x + encodeURI("id:" + _.join(" OR id:"))),
            (T4SThemeSP.linkWishlist = C),
            n.trigger("update:mini_cart:wishlist"));
        }
        function M() {
        ...
        function U(e, n) {
          ...
          i.addClass(g).removeClass(h).find(".t4s-text-pr").text(b),
            ...
            (!isStorageSpdLocalAll && a) ||
              ...
              E &&
                (window.isEmtyWishlist && window.isWishlistPerformed
                  ...
                  : (window.countWishlistPage != _.length &&
                      window.isWishlistPerformed &&
                      (t(f).html(window.countWishlistPage),
                  ...
                  a
                    ? (function (e) {
                        var n = e.data("id") || "",
                          ...
                          o = !1;
                        if ("" != n) {
                          if ((e.addClass(h), null != a && a.length > 0))
                            (r = a.split(",")).unshift(i);
                          else {
                            var r = [];
                            r.unshift(i);
                          ...
                          if (
                            ...
                            var s = t(c + g);
                            s.removeClass(g).find(".t4s-text-pr").text(y),
                              s.find(".t4s-svg-pr-icon").html(T),
                              M();
                          } else U(n, e);
          ...
          (function () {
            ...
            if (
              ...
              !(
                ...
                (!u.stts.isMobile && 768 > e.width()) ||
                u.$popup.hasClass(c)
              ))
            ) {
              var s = `${a}_newsletter${"1" == u.pp_version ? "2" : "1"}`;
              if (
                ("shown" == CookiesT4.get(s) && CookiesT4.remove(s),
                u.$popup.addClass(c),
                (u.day_next = u.stts.day_next),
                (u.scroll_delay = u.stts.scroll_delay),
                (u.after = u.stts.after),
                A)
              ) {
                            ...
                            h.pauseOnHover &&
                              h.$temp
                                .on("mouseenter", function (t) {
                                  h.resetOnHover
                                    ? h.$progressbarSpan.css(
                                        "animation-name",
                                        "none"
                                      )
                                    : (h.time.REMAINING =
                                        h.time.END - new Date().getTime()),
              ...
              d.attr("max", c),
                ...
                (this.ArrayPrice[s] == f && this.ArrayComparePrice[s] == m) ||
                  ...
                  m > f
                    ...
                    : h.html(T4SThemeSP.Currency.formatMoney(f)),
    ...
    (T4SThemeSP.initGroupsProduct = function () {
      ...
      (T4SThemeSP.CanvasConfetti = (function () {
        ...
        function y() {
          (p = !0),
            null != n && (n.clearRect(0, 0, i, a), (t.style.display = "none"));
        }
        return (
          ...
          function () {
            ...
            T4SThemeSP.$appendComponent.after(
              ...
              (n = (t = document.getElementById("confettiCanvas")).getContext(
                "2d"
              )),
              (i = window.innerWidth),
              (a = window.innerHeight),
...
function cartGiftUpdate(o, n, a, s, l) {
  console.log(new Date(), "33333333333333")
  ...
  var total_pre_order_product = 0;

  var all_prod_to_remove = [];
  var all_prod_to_add = [];
  var show_confetti = false;

  var landing_page_list = $("body #landing_gift_wrap .for-landing-page").attr(
    "data-landing-list"
  );
  var landing_page_array = landing_page_list
    ? landing_page_list.split(",")
    : [];
  let l_trigger_price_1 = parseInt(
    $("body #landing_gift_wrap .for-landing-page").attr(
      "landing_trigger-price-1"
    )
  );
  let l_gift_product_1 = $("body #landing_gift_wrap .for-landing-page").attr(
    "landing_gift-product-1"
  );
  let l_trigger_prod_count_1 = parseInt(
    $("body #landing_gift_wrap .for-landing-page").attr(
      "landing_free-gift-v1-trigger-count-1"
    )
  );
  let l_trigger_price_2 = parseInt(
    $("body #landing_gift_wrap .for-landing-page").attr(
      "landing_trigger-price-2"
    )
  );
  let l_gift_product_2 = $("body #landing_gift_wrap .for-landing-page").attr(
    "landing_gift-product-2"
  );
  let l_trigger_prod_count_2 = parseInt(
    $("body #landing_gift_wrap .for-landing-page").attr(
      "landing_free-gift-v1-trigger-count-2"
    )
  );
  let all_landing_gift_prod = $("body").attr("all_landing_gift_prod");
  let all_landing_gift_prod_array = all_landing_gift_prod
    ? all_landing_gift_prod.split(",")
    : [];
  ...
  jQuery
    .getJSON("/cart.js", function (cart) {
      ...
      current_path = current_path.replace("/collections/", "");

      // for native cart gift functionality start =================
      if (!landing_page_array.includes(current_path)) {
        if (gift_product_1 && trigger_price_1) {
          var bodycare_price_total = 0;
          $.each(cart.items, function (index, value) {
            ...
            var product_type_value = value.product_type;
            // if (product_type_value == "Bodycare") {
            //   total_pre_order_product =
            //     total_pre_order_product + value.quantity;
            //   bodycare_price_total = bodycare_price_total + value.price;
            // }
          });
          let cart_count =
            cart.item_count - total_free_prod_count - total_pre_order_product;
          
          let trigger_prod_count_1 = parseInt(
            $("body").attr("free-gift-v1-trigger-count-1")
          );
          let trigger_prod_count_2 = parseInt(
            $("body").attr("free-gift-v1-trigger-count-2")
          );
          let cart_total = cart.items_subtotal_price - bodycare_price_total;
          ...
          if (cart_count == 0) {
            if (
              gift_product_1 &&
              trigger_price_1 &&
              current_product_array.includes(gift_product_1)
            ) {
            ...
            if (
              gift_product_2 &&
              trigger_price_2 &&
              current_product_array.includes(gift_product_2)
            ) {
          ...
          if (cart_total == 0) {
            setTimeout(function () {
              ...
              $("#t4s-mini_cart #all_cart_spin #t4s_cart_spinner").attr(
                "hidden",
                true
              );
            }, 2000);
          ...
          if (
            cart_total <= trigger_price_1 * 100 ||
            cart_count < trigger_prod_count_1
          ) {
            if (
              gift_product_1 &&
              trigger_price_1 &&
            ...
            if (trigger_price_2 && gift_product_2) {
              if (
                (cart_total <= trigger_price_2 * 100 ||
                  remove_prod_base_count) &&
                cart_count >= trigger_prod_count_1
              ) {
                if (
                  gift_product_1 &&
        ...
        if (
          all_prod_to_remove.indexOf(gift_product_1) < 0 &&
          gift_product_1 &&
          current_product_array.includes(gift_product_1) &&
          gift_product_1 != l_gift_product_1
        ) {
          all_prod_to_remove.push(gift_product_1);
        }
        if (
          all_prod_to_remove.indexOf(gift_product_2) < 0 &&
          gift_product_2 &&
          current_product_array.includes(gift_product_2) &&
          gift_product_2 != l_gift_product_2
        ) {
          all_prod_to_remove.push(gift_product_2);
        }
      }
      ...
      // for Landing page base cart gift functionality start =================
      if (landing_page_array.includes(current_path)) {
        // console.log("landing 1111", l_trigger_price_1, l_trigger_prod_count_1);
        if (l_gift_product_1 && l_trigger_price_1) {
          let cart_count = 0;
          $.each(cart.items, function (index, value) {
            current_product_array.push(value.id.toString());
            if (value.final_line_price == 0 && value.original_line_price == 0) {
            ...
            // if (value.final_line_price != 0 && value.original_line_price != 0) {
            if (value.original_line_price != 0) {
              cart_count = cart_count + value.quantity;
            }
          });
          // let cart_count = cart.item_count - total_free_prod_count;
          let cart_total = cart.items_subtotal_price;

          if (l_trigger_prod_count_2 == 0) {
            var remove_prod_base_count = false;
            var add_prod_base_count = true;
          } else {
            if (cart_count < l_trigger_prod_count_2) {
              var remove_prod_base_count = true;
              var add_prod_base_count = false;
            } else {
              var remove_prod_base_count = false;
          ...
          if (
            cart_total <= l_trigger_price_1 * 100 ||
            cart_count < l_trigger_prod_count_1
          ) {
            // console.log("landing 2222");
            if (
              l_gift_product_1 &&
              l_trigger_price_1 &&
              current_product_array.includes(l_gift_product_1)
            ) {
              if (all_prod_to_remove.indexOf(l_gift_product_1) < 0) {
                all_prod_to_remove.push(l_gift_product_1);
              }
            }
            if (
              l_gift_product_2 &&
              l_trigger_price_2 &&
              current_product_array.includes(l_gift_product_2)
            ) {
              if (all_prod_to_remove.indexOf(l_gift_product_2) < 0) {
                all_prod_to_remove.push(l_gift_product_2);
              }
            }
          } else {
            // console.log("landing 3333");
            if (l_trigger_price_2 && l_gift_product_2) {
              if (
                (cart_total <= l_trigger_price_2 * 100 ||
                  remove_prod_base_count) &&
                cart_count >= l_trigger_prod_count_1
              ) {
                // console.log("landing 4444");
                if (
                  l_gift_product_1 &&
                  !current_product_array.includes(l_gift_product_1)
                ) {
                  ...
                  if (all_prod_to_add.indexOf(l_gift_product_1) < 0) {
                    all_prod_to_add.push(l_gift_product_1);
                    show_confetti = true;
                  }
                } else {
                  if (all_prod_to_remove.indexOf(l_gift_product_2) < 0) {
                ...
                if (
                  ...
                  if (
                    ...
                    if (all_prod_to_add.indexOf(l_gift_product_2) < 0) {
                      all_prod_to_add.push(l_gift_product_2);
                      show_confetti = true;
                    }
                  } else {
                    if (all_prod_to_add.indexOf(l_gift_product_2) < 0) {
              ...
              // console.log("landing 6666");
              if (
                l_gift_product_1 &&
                !current_product_array.includes(l_gift_product_1)
              ) {
                // console.log("landing 7777");
                if (all_prod_to_add.indexOf(l_gift_product_1) < 0) {
                  // console.log("landing 8888");
                  all_prod_to_add.push(l_gift_product_1);
                  show_confetti = true;
                }
              }
        ...
        $.each(all_landing_gift_prod_array, function (index, value) {
          if (
            current_product_array.includes(value) &&
            all_prod_to_remove.indexOf(value) < 0 &&
            value != l_gift_product_1 &&
            value != l_gift_product_2
          ) {
            all_prod_to_remove.push(value);
          }
        });
      } else {
        // console.log("not included","landing");
        //   $.each(all_landing_gift_prod_array, function(index, value) {
        //     if (current_product_array.includes(value) && all_prod_to_remove.indexOf(value) < 0) {
        //       all_prod_to_remove.push(value);
        //     }
        //   });
      }
      // for Landing page base cart gift functionality end =================
      ...
      if (working_magic_key) {
        var magic_link_type = $(
          '#magic_link_wrap div[data-link-key="' + working_magic_key + '"]'
        ).attr("data-for");
        if (magic_link_type == "cart") {
          var magic_trigger_price = $(
            '#magic_link_wrap div[data-link-key="' + working_magic_key + '"]'
          ).attr("data-trigger-price");
          var magic_gift_product = $(
            '#magic_link_wrap div[data-link-key="' + working_magic_key + '"]'
          ).attr("data-gift-product");
          ...
          if (
            cart_total > magic_trigger_price &&
            !current_product_array_all.includes(magic_gift_product)
          ) {
            if (all_prod_to_add.indexOf(magic_gift_product) < 0) {
              all_prod_to_add.push(magic_gift_product);
            }
          } else if (
            magic_trigger_price >= cart_total &&
            current_product_array_all.includes(magic_gift_product)
          ) {
          ...
          var magic_trigger_product = $(
            '#magic_link_wrap div[data-link-key="' + working_magic_key + '"]'
          ).attr("data-trigger-product");
          var magic_trigger_count = $(
            '#magic_link_wrap div[data-link-key="' + working_magic_key + '"]'
          ).attr("data-trigger-count");
          var magic_gift_product = $(
            '#magic_link_wrap div[data-link-key="' + working_magic_key + '"]'
          ).attr("data-gift-product");
          var current_product_array_all = [];
          ...
          $.each(cart.items, function (index, value) {
            ...
            if (value.product_id.toString() == magic_trigger_product) {
              total_trigger_qty_in_cart =
                total_trigger_qty_in_cart + value.quantity;
            }
          });
          let cart_total = cart.items_subtotal_price / 100;
          if (
            total_trigger_qty_in_cart >= magic_trigger_count &&
            !current_product_array_all.includes(magic_gift_product)
          ) {
            if (all_prod_to_add.indexOf(magic_gift_product) < 0) {
              all_prod_to_add.push(magic_gift_product);
          ...
          var magic_trigger_collection = $(
            '#magic_link_wrap div[data-link-key="' + working_magic_key + '"]'
          ).attr("data-trigger-collection");
          var magic_trigger_count = $(
            '#magic_link_wrap div[data-link-key="' + working_magic_key + '"]'
          ).attr("data-trigger-count");
          var magic_gift_product = $(
          ...
          var current_product_array_all = [];
          var trigger_collection_prod_array =
            magic_trigger_collection.split(",");
          var total_trigger_qty_in_cart = 0;

          $.each(cart.items, function (index, value) {
            current_product_array_all.push(value.id.toString());
            if (
              trigger_collection_prod_array.includes(
    ...
    .then(function () {
      ...
      // $('.gift_lock_list').css('opacity',0);
      // console.log(
      //   "jsonObjectFinal landing",
      //   jsonObjectFinal,
      //   Object.keys(variantObject_final).length
      // );
      if (Object.keys(variantObject_final).length) {
        ...
        $.ajax({
          ...
          complete: function (data) {
            ...
            console.log(new Date(), "44444444444444")
            
            let cartData = data.responseJSON.items;
            // document.dispatchEvent(new CustomEvent('cart:build', {
            //     bubbles: true
            // }));
            document.dispatchEvent(
              new CustomEvent("cart:refresh:opend", {
                bubbles: true,
                detail: cartData,
              })
            );
        ...
        $("#t4s-mini_cart #all_cart_spin_new #t4s_cart_spinner_new").attr(
          "hidden",
          true
        );
      }
...
function first_time_confeti() {
  jQuery.getJSON(
    ...
    function (cart) {
      ...
      if (cartData == 1) {
        const svgContainer_outer =
          document.getElementById("confetti_svg_outer");
        let animItem = bodymovin.loadAnimation({
          wrapper: svgContainer_outer,
          animType: "svg",
          loop: false,
