...
function cartGiftUpdate(o, n, a, s, l) {
    ...
    var landing_page_list = $("body #landing_gift_wrap .for-landing-page").attr("data-landing-list");
    var landing_page_array = landing_page_list ? landing_page_list.split(',') : [];
    let l_trigger_price_1 = parseInt($("body #landing_gift_wrap .for-landing-page").attr("landing_trigger-price-1"));
    let l_gift_product_1 = $("body #landing_gift_wrap .for-landing-page").attr("landing_gift-product-1");
    let l_trigger_prod_count_1 = parseInt($("body #landing_gift_wrap .for-landing-page").attr("landing_free-gift-v1-trigger-count-1"));
    let l_trigger_price_2 = parseInt($("body #landing_gift_wrap .for-landing-page").attr("landing_trigger-price-2"));
    let l_gift_product_2 = $("body #landing_gift_wrap .for-landing-page").attr("landing_gift-product-2");
    let l_trigger_prod_count_2 = parseInt($("body #landing_gift_wrap .for-landing-page").attr("landing_free-gift-v1-trigger-count-2"));
    let all_landing_gift_prod = $("body").attr("all_landing_gift_prod");
    let all_landing_gift_prod_array = all_landing_gift_prod ? all_landing_gift_prod.split(',') : [];
    ...
    jQuery.getJSON('/cart.js', function(cart) {
        ...
        if (!landing_page_array.includes(current_path)) {
            ...
            $.each(cart.items, function(index, value) {
              ...
              var product_type_value = value.product_type;
                if (product_type_value == 'Bodycare') {
                    total_pre_order_product = total_pre_order_product + value.quantity;
                  bodycare_price_total = bodycare_price_total + value.price;
                }
            });
            let cart_count = cart.item_count - total_free_prod_count - total_pre_order_product;
          console.log("cart_count",cart_count);
            ...
            if (all_prod_to_remove.indexOf(gift_product_1) < 0 && gift_product_1 && current_product_array.includes(gift_product_1)) {
                all_prod_to_remove.push(gift_product_1);
            }
            if (all_prod_to_remove.indexOf(gift_product_2) < 0 && gift_product_2 && current_product_array.includes(gift_product_2)) {
                all_prod_to_remove.push(gift_product_2);
            }
        }
        ...
        if (landing_page_array.includes(current_path)) {
          ...
          if (l_gift_product_1 && l_trigger_price_1) {
            ...
            if (cart_total <= l_trigger_price_1 * 100 || cart_count < l_trigger_prod_count_1) {
              console.log("landing 2222");
                if (l_gift_product_1 && l_trigger_price_1 && current_product_array.includes(l_gift_product_1)) {
                    if (all_prod_to_remove.indexOf(l_gift_product_1) < 0) {
                        all_prod_to_remove.push(l_gift_product_1);
                    }
                }
                if (l_gift_product_2 && l_trigger_price_2 && current_product_array.includes(l_gift_product_2)) {
              ...
              console.log("landing 3333");
                if (l_trigger_price_2 && l_gift_product_2) {
                    if ((cart_total <= l_trigger_price_2 * 100 || remove_prod_base_count) && cart_count >= l_trigger_prod_count_1) {
                      console.log("landing 4444");
                        if (l_gift_product_1 && !(current_product_array.includes(l_gift_product_1))) {
                          
                            if (l_gift_product_2 && current_product_array.includes(l_gift_product_2)) {
                                if (all_prod_to_remove.indexOf(l_gift_product_2) < 0) {
                                    all_prod_to_remove.push(l_gift_product_2);
                                }
                            }
                      ...
                      console.log("landing 5555");
                        if (l_gift_product_2 && !current_product_array.includes(l_gift_product_2) && add_prod_base_count) {
                            if (l_gift_product_1 && current_product_array.includes(l_gift_product_1)) {
                                if (all_prod_to_remove.indexOf(l_gift_product_1) < 0) {
                                    all_prod_to_remove.push(l_gift_product_1);
                                }
          ...
          $.each(all_landing_gift_prod_array, function(index, value) {
              if (current_product_array.includes(value) && all_prod_to_remove.indexOf(value) < 0 && value != l_gift_product_1 && value != l_gift_product_2 ) {
        ...
        console.log("jsonObjectFinal landing", jsonObjectFinal, Object.keys(variantObject_final).length);
