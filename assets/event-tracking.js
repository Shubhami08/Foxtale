...
const eventConfig = [
  ...
  },
  {
    ...
    apiDataMap: {
      ...
      // cartDiscounts: "total_discount",
      // cartItemCount: "item_count"
      "Viewed cart item id": "id",
      "Viewed cart item title": "handle",
      "Viewed cart item url": "url",
      "Viewed cart item price": "price",
      "Viewed cart item type": "product_type",
      "Viewed cart item sku": "sku",
      "Viewed cart item availability": "available",
      "Viewed cart item max price": "price_max",
      "Viewed cart item min price": "price_min",
      productTitle: "title",
      tags: "tags",
    },
    elementDataMap: {},
  ...
  },
  {
    ...
    apiDataMap: {
      ...
      "Viewed product type": "product_type",
  ...
  },
  {
    ...
    apiDataMap: {
      ...
      "Added to Product URL": "url",
      "Added to Product Price": "price",
      "Added to Product Type": "product_type",
      "Added to Product SKU": "sku",
      "Added to Product Availability": "available",
      "Added to Product Max Price": "price_max",
      "Added to Product Min Price": "price_min",
      "Added to Product Title": "title",
      "Added to Product Tags": "tags",
    },
    elementDataMap: {},
    constDataMap: {
      source_domain: sourceDomain,
...
function trackEvent(eventName, properties) {
  ...
  const base64Data = btoa(unescape(encodeURIComponent(str)));
