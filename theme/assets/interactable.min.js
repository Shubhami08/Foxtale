...
function cartGiftUpdate(o,n,a,s,l) {
  ...
  jQuery.getJSON('/cart.js', function (cart) {
    console.log(cart,"1111111.......")
            $.each(cart.items, function( index, value ) {
              current_product_array.push( value.id.toString() );
              if(value.final_line_price == 0){
            ...
            console.log(current_product_array,"#####",cart_total);

            console.log("%%%%",current_product_array.includes(gift_product_1))
            if(cart_total <= trigger_price_1 *100 || cart_count < trigger_prod_count_1){
              if(gift_product_1 && trigger_price_1 && current_product_array.includes(gift_product_1)){
                var removeproductId1 = gift_product_1;
                      console.log("native product-11111 removed");
                      var variantObject1 = {};
                      variantObject1[removeproductId1] = 0;
                      var jsonObject1 = {}
                      jsonObject1['updates'] = variantObject1;
                      $.ajax({
                        type: "post",
                        url: "/cart/update.js",
                        data: jsonObject1,
              ...
              if(gift_product_2 && trigger_price_2 && current_product_array.includes(gift_product_2)){
                var removeproductId2 = gift_product_2;
                      console.log("native product-2222222 removed");
                console.log("gifts if 2 ",gift_product_1,gift_product_2)
                      var variantObject2 = {};
                      variantObject2[removeproductId2] = 0;
                      var jsonObject2 = {}
                      jsonObject2['updates'] = variantObject2;
                  console.log("gifts if 2  reovning obj",jsonObject2)
                      $.ajax({
                        type: "post",
                        url: "/cart/update.js",
                        data: jsonObject2,
              ...
              if(gift_product_1 && trigger_price_1 && !current_product_array.includes(gift_product_1) || (gift_product_2 && trigger_price_2 && !current_product_array.includes(gift_product_2))){
                $("#t4s-mini_cart").removeClass("is--contentUpdate");
                $("#t4s-mini_cart #all_cart_spin").attr("hidden",true);
                $("#t4s-mini_cart #all_cart_spin #t4s_cart_spinner").attr("hidden",true);
              }
              ...
              if(trigger_price_2 && gift_product_2){
                if((cart_total <= trigger_price_2 * 100 || remove_prod_base_count) && cart_count >= trigger_prod_count_1){
                  // var removeproductId = gift_product_2;
                  // var variantObject = {};
                  // variantObject[removeproductId] = 0;
                  // var jsonObject = {}
                  ...
                  if(gift_product_1 && !(current_product_array.includes(gift_product_1))){
                    var productId11 = gift_product_1;
                      $.ajax({
                        type: 'POST',
                        url: '/cart/add.js',
                        dataType: 'json',
                        data: { id: productId11, quantity: 1 },
                        success: function(data) {
                        ...
                        complete:function() {
                          console.log("native product-1111111 added....");
                          if(gift_product_2 && current_product_array.includes(gift_product_2)){
                          var removeproductId55 = gift_product_2;
                          
                          var variantObject55 = {};
                          variantObject55[removeproductId55] = 0;
                          var jsonObject55 = {}
                          jsonObject55['updates'] = variantObject55;
                          $.ajax({
                            type: "post",
                            url: "/cart/update.js",
                            data: jsonObject55,
                  ...
                  // var removeproductId = gift_product_1;
                  // var variantObject = {};
                  // variantObject[removeproductId] = 0;
                  // var jsonObject = {}
                  // jsonObject['updates'] = variantObject;
                  ...
                  if(gift_product_2 && !current_product_array.includes(gift_product_2) && add_prod_base_count){
                    var productId2 = gift_product_2;
                    console.log("native product-222222 added");
                    if(gift_product_1 && current_product_array.includes(gift_product_1)){
                      var removeproductId1 = gift_product_1;
                          console.log("native product-11111 removed");
                          var variantObject1 = {};
                          ...
                          $.ajax({
                            ...
                            complete:function() {
                              console.log("native product-11111 removed........success");
                              $.ajax({
                                type: 'POST',
                                url: '/cart/add.js',
                                dataType: 'json',
                                data: { id: productId2, quantity: 1 },
                                success: function(data) {
                                },
                                complete:function() {
                                  jQuery.getJSON('/cart.js', function (cart) {
                          ...
                          $.ajax({
                            ...
                            complete:function() {
                              console.log("native product-222222 added...........success");
                                jQuery.getJSON('/cart.js', function (cart) {
                                    let cartData = cart.items;
                                    document.dispatchEvent(new CustomEvent('cart:build', { bubbles: true }));
                                    document.dispatchEvent(new CustomEvent('cart:refresh:opend', {
  ...
  var free_gift_claim_tags = $("body").attr("tag-list");
  if(free_gift_claim_tags){
    var prod_with_tag_ids = [];
    var gift_claim_trigger_count = $("body").attr("trigger-qty");
    var total_prod_with_tag = 0;
    var free_gift_list = $("#free_gift_claim").attr("free-gift-list");
    var free_gift_prod_array = free_gift_list.split(',');
    var gift_already_added = 0;
  }
  if(free_gift_claim_tags){
    console.log(free_gift_claim_tags,"free_gift_claim_tags");
    var free_gift_claim_array = free_gift_claim_tags.split(',');
  
    jQuery.getJSON('/cart.js', function (cart) {
        $.each(cart.items, function( index, value ) {
          var current_product_url = value.url;
          console.log("**********************",value,value.id);
          current_product_url = current_product_url.replace("?", ".json?");
          // console.log("**********************",current_product_url);
            ...
            $.ajax({
                ...
                dataType: 'json',
                success: function(data) {
                  var current_product_tags = data['product'].tags;
                  console.log("second success -------",current_product_tags);
                  $.each(free_gift_claim_array, function( index, free_gift_tag ) {
                    if(current_product_tags.includes(free_gift_tag)){
                      // console.log( "second success 1111 *************",total_prod_with_tag );
                      if(!prod_with_tag_ids.includes(data['product'].id)){
                        prod_with_tag_ids.push(data['product'].id); 
                        total_prod_with_tag = total_prod_with_tag + value.quantity;
                        // console.log( "second success ------ *************",total_prod_with_tag );
                      }
                    }
                  });
                },
          ...
          if(free_gift_prod_array.includes((value.id).toString())){
            gift_already_added = 1;
          }
    ...
    .done(function() {
      setTimeout(function() {
        console.log( "second success",total_prod_with_tag , gift_already_added , "gift_already_added" );
        if(total_prod_with_tag >= gift_claim_trigger_count && prod_with_tag_ids.length > 1){
          if(gift_already_added != 1){
            $("#t4s-mini_cart .free_gift_claim").show();  
          }else{
            $("#t4s-mini_cart .free_gift_claim").hide(); 
          }
        }else{
          $("#t4s-mini_cart .free_gift_claim").hide();   
          var free_gift_remove = $("#free_gift_claim").attr("free-gift-list");
          var free_gift_remove_array = free_gift_remove.split(',');
          var variantObject44 = {};
        
          $.each(free_gift_remove_array, function( index, free_gift_id ) {
              var removeproductId44 = free_gift_id;
              variantObject44[removeproductId44] = 0;
          });
          var jsonObject44 = {}
          jsonObject44['updates'] = variantObject44;
            $.ajax({
              type: "post",
              url: "/cart/update.js",
              data: jsonObject44,
      ...
      jQuery.getJSON('/cart.js', function (cart) {
            ...
            if(cart_total > magic_trigger_price && !(current_product_array_all.includes(magic_gift_product))){
              $.ajax({
                ...
                url: '/cart/add.js',
                dataType: 'json',
                data: { id: magic_gift_product, quantity: 1 },
                success: function(data) {
                  jQuery.getJSON('/cart.js', function (cart) {
                    let cartData = cart.items;
                    document.dispatchEvent(new CustomEvent('cart:build', { bubbles: true }));
              ...
              $.ajax({
                ...
                complete:function() {
                  ...
                  console.log("magic","ajax ---------------","product remove.......");
                }
              });
            }else{
                $("#t4s-mini_cart").removeClass("is--contentUpdate_new");
...
function add_free_gift_to_cart(add_prod_id){
  ...
  $.ajax({
    ...
    url: '/cart/add.js',
    dataType: 'json',
    data: { id: add_prod_id, quantity: 1 },
    success: function(data) {
    },
    complete:function() {
      jQuery.getJSON('/cart.js', function (cart) {
        ...
        setTimeout(function() {
          // var o = $("#t4s-mini_cart[data-cart-wrapper]"),
          //   s = o.find("#all_cart_spin"),
          //   l = s.find(".t4s-cart-spinner");
